...
public class Chinese07 extends AppCompatActivity implements OnMapReadyCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chinese07);
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        LatLng location = new LatLng(37.4678477,126.935563);

        MarkerOptions markerOptions = new MarkerOptions();
        markerOptions.position(location);
        markerOptions.title("신림왕꼬치");
        markerOptions.snippet("양꼬치");
    ...
    View.OnClickListener tvListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            Uri uri = Uri.parse("tel:028782588");
