...
public class Korean85 extends AppCompatActivity implements OnMapReadyCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_korean85);
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        markerOptions.title("황해도빈대떡");
        markerOptions.snippet("전, 빈대떡");
...
//        googleMap.addMarker(new MarkerOptions().position(location).title("가마솥한방삼계탕"));
    ...
    View.OnClickListener tvListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            Uri uri = Uri.parse("tel:028728587");
