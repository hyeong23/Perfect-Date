...
public class Chinese03 extends AppCompatActivity implements OnMapReadyCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chinese03);
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        LatLng location = new LatLng(37.4703152,126.9316097);

        MarkerOptions markerOptions = new MarkerOptions();
        markerOptions.position(location);
        markerOptions.title("사랑마라탕");
    ...
    View.OnClickListener tvListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            Uri uri = Uri.parse("tel:050713055918");
