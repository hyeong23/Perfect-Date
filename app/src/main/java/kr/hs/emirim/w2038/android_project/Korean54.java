...
public class Korean54 extends AppCompatActivity implements OnMapReadyCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_korean54);
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        LatLng location = new LatLng(37.4702662,126.9347507);

        MarkerOptions markerOptions = new MarkerOptions();
        markerOptions.position(location);
        markerOptions.title("수유 다래함박스텍");
    ...
    View.OnClickListener tvListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            Uri uri = Uri.parse("tel:028787942");
