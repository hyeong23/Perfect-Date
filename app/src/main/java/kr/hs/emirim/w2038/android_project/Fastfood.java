...
public class Fastfood extends AppCompatActivity {
    ...
    View.OnClickListener btnListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                case R.id.btn1:
                    intent = new Intent(Fastfood.this, Fastfood01.class);
                    startActivity(intent);
                    break;
                case R.id.btn2:
                    intent = new Intent(Fastfood.this, Fastfood02.class);
                    startActivity(intent);
                    break;
                case R.id.btn3:
                    intent = new Intent(Fastfood.this, Fastfood03.class);
                    startActivity(intent);
                    break;
                case R.id.btn4:
                    intent = new Intent(Fastfood.this, Fastfood04.class);
                    startActivity(intent);
                    break;
            }
        }
