...
public class Etc extends AppCompatActivity {
    ...
    View.OnClickListener btnListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                case R.id.btn1:
                    intent = new Intent(Etc.this, Etc01.class);
                    startActivity(intent);
                    break;
                case R.id.btn2:
                    intent = new Intent(Etc.this, Etc02.class);
                    startActivity(intent);
                    break;
                case R.id.btn3:
                    intent = new Intent(Etc.this, Etc03.class);
                    startActivity(intent);
                    break;
                case R.id.btn4:
                    intent = new Intent(Etc.this, Etc04.class);
                    startActivity(intent);
                    break;
                case R.id.btn5:
                    intent = new Intent(Etc.this, Etc05.class);
                    startActivity(intent);
                    break;
                case R.id.btn6:
                    intent = new Intent(Etc.this, Etc06.class);
                    startActivity(intent);
                    break;
                case R.id.btn7:
                    intent = new Intent(Etc.this, Etc07.class);
                    startActivity(intent);
                    break;
            }
        }
