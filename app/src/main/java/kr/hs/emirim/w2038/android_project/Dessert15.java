...
public class Dessert15 extends AppCompatActivity implements OnMapReadyCallback{
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        LatLng location = new LatLng(37.4692397,126.9357613);

        MarkerOptions markerOptions = new MarkerOptions();
        markerOptions.position(location);
        markerOptions.title("승승밀크티");
    ...
    View.OnClickListener tvListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            Uri uri = Uri.parse("tel:01088022212");
