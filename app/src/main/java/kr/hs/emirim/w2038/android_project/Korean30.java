...
public class Korean30 extends AppCompatActivity implements OnMapReadyCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_korean30);
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        LatLng location = new LatLng(37.4700597,126.9314574);

        MarkerOptions markerOptions = new MarkerOptions();
        markerOptions.position(location);
        markerOptions.title("모르겐고깃집");
    ...
    View.OnClickListener tvListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            Uri uri = Uri.parse("tel:028749898");
